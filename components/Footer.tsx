...
const mail = `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="m4 7 8 6 8-6"/></svg>`;
        ...
        <div className="qs-foot-cols">
          ...
          <div>
            ...
            <ul className="flex flex-row flex-wrap items-center gap-3">
              ...
              <Social href="#" svg={zalo} label="Zalo" />
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-6">
              <ContactGroup svg={phone} label="Số điện thoại">
              ...
              <ContactGroup svg={mail} label="Email">
                <Line href="mailto:hieu.nguyen-sm@qstcnc.com">hieu.nguyen-sm@qstcnc.com</Line>
                <Line href="mailto:viktor.vu@qstcnc.com">viktor.vu@qstcnc.com</Line>
              </ContactGroup>
  ...
  return (
    <li>
      <a href={href} aria-label={label} title={label}
         className="block text-[#c2bdb0] hover:text-gold-2 transition-colors hover:-translate-y-0.5 will-change-transform">
        <GoldIcon svg={svg} />
      </a>
    </li>
  );
