...
export default async function Footer() {
  ...
  // No gap above the footer: the last section's own bottom padding plus
  // .qs-foot-inner's padding-top already give enough breathing room, and any extra
  // margin exposes a strip of page background between the two.
  return (
    <footer className="qs-foot relative overflow-hidden">
