            ...
            >
              ...
              <div className="p-8 lg:p-12 flex flex-col justify-between">
                <div>
                  ...
                  <h2 className="font-display font-bold text-h2 tracking-[-.015em] leading-[1.6] mt-4 mb-4 text-balance line-clamp-3 group-hover:text-ink transition-colors">{feat.title}</h2>
