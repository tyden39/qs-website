      ...
      <section className="relative overflow-hidden border-b border-line"
        ...
        <div className="relative max-w-wrap mx-auto px-12 pt-16 pb-20">
          <div className="grid md:grid-cols-[1.05fr_1fr] gap-16 items-center">
            <div>
              <div className="qs-eyebrow">QS Technology · Made by Vietnam · 2026</div>
              ...
              <div className="flex gap-3 mt-8">
                <Link className="qs-btn qs-btn-gold" href="/products/astro-10i">Thông tin chi tiết →</Link>
              </div>
            </div>
      ...
      <section className="py-24 bg-paper">
        <div className="max-w-wrap mx-auto px-12">
            ...
            {apps.map(a => (
              <Link key={a.slug} href={`/applications/${a.slug}`}
                ...
                <div className="relative aspect-[5/4] border border-line overflow-hidden"
                  ...
                  <Image src={a.img} alt={a.t} fill sizes="(max-width:768px) 50vw, 25vw" className="object-cover" />
                </div>
          ...
          <div className="flex justify-center mt-10">
            <Link className="qs-btn qs-btn-gold" href="/applications">Xem thêm →</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-wrap mx-auto px-12">
          <div className="qs-section-head">
            ...
            <Link className="qs-btn qs-btn-ghost qs-btn-sm" href="/products">Xem tất cả →</Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-line border border-line">
            {homeProducts.map((item, i) => (
              <Link key={`${item.slug}-${i}`} href={`/products/${item.slug}`}
          ...
          <div className="flex justify-center mt-10">
            <Link className="qs-btn qs-btn-gold" href="/products">Xem thêm →</Link>
          </div>
        </div>
      </section>
        ...
        <div className="relative max-w-wrap mx-auto px-12">
          <div className="grid md:grid-cols-[1.4fr_1fr] gap-16 items-center">
            <div>
              ...
              <Link className="qs-btn qs-btn-gold mt-8" href="/about">Xem thêm →</Link>
            </div>
            ...
            <Link href="/news/astro-12x"
              ...
              <div className="relative aspect-[5/3] bg-ink-2 border-b border-line overflow-hidden">
                <Image src="/home/news-ethercat.webp" alt="QS ra mắt dòng controller EtherCAT, Mechatrolink MII/MIII" fill
                       sizes="(max-width:768px) 100vw, 55vw" className="object-cover" />
              </div>
              <div className="p-7">
        ...
        <div className="max-w-wrap mx-auto px-12">
          <div className="bg-ink text-[#cfc9b8] p-12 grid md:grid-cols-[1fr_340px] gap-10 items-center overflow-hidden">
            <div>
              ...
              <Link className="qs-btn qs-btn-gold mt-7" href="/contact">Liên hệ ngay →</Link>
            </div>
